...
public class SplitwiseDao {
     ...
     */
    public SplitwiseDao(String consumerKey, String consumerSecret){
    ...
    public static void main(String... args) throws Exception {
        SplitwiseDao splitwise = new SplitwiseDao("qRn9eoONfoUGWmBwpQ1mjgRNyGGSgGFOF4R3SEa0",
                "QSxygjMhoxUQNf2pRUsUA2sKb93oQrlJWwFoFwn5");

        String authorizationURL = splitwise.getAuthorizationUrl();
        System.out.println(authorizationURL);

        splitwise.util.setAccessToken("MNCOnzHeL88tUtB9BY1w");
